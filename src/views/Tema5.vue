...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mt-5 Los componentes de la aplicación son mecanismos de creación básicos de una aplicación para <i>Android</i>. Cada componente es un punto de entrada por el que el sistema o un usuario ingresan a una aplicación. Algunos componentes dependen de otros.
    ...
    .row.mt-5
      .col-8.offset-2.py-3.rounded-20.borde-primario-4
        .row
          ...
          .col-12.col-lg-9.align-self-center.px-4
            p.m-0 Un <i>broadcast receiver</i> es un componente destinado a detectar y reaccionar ante determinados mensajes o eventos globales generados por el sistema (por ejemplo: “Batería baja”, “SMS recibido”, “Tarjeta SD insertada”…) o por otras aplicaciones [cualquier aplicación puede generar mensajes (<i>intents</i>, en terminología <i>Android</i>) de tipo <i>broadcast</i>, es decir, no dirigidos a una aplicación concreta sino a cualquiera que quiera escucharlo].
